      ...
      <main>
        ...
        <section className="hero-wash relative overflow-hidden px-4 pt-20 pb-24 lg:pt-28 lg:pb-32">
          <div className="container relative mx-auto max-w-4xl text-center">
            <p className="inline-block rounded-full border border-brand/45 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.18em] text-brand">
            ...
            <h1
              className="font-display mt-7 text-[38px] leading-[1.06] tracking-[-0.01em] text-ink sm:text-[52px] lg:text-[66px]"
              style={{ textWrap: 'balance' }}
            >
              {COPY.home.heroHeadline}{' '}
              <br className="hidden sm:block" />
              <em className="not-italic text-brand">{COPY.home.heroHighlight}</em>
            </h1>
            <p
            ...
            <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <Link
                href="/casinos"
                className="btn-primary flex min-h-11 w-full items-center justify-center rounded-full px-7 py-3.5 text-[15px] font-semibold sm:w-auto"
              >
              ...
              {anyOffersVisible && (
                <Link
                  href="/special-offers"
                  className="btn-ghost flex min-h-11 w-full items-center justify-center rounded-full px-7 py-3.5 text-[15px] font-semibold sm:w-auto"
                >
